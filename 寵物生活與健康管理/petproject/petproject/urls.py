...
urlpatterns = [
    ...
    path("accounts/3rdparty/signup/", CustomSocialSignupView.as_view(), name="socialaccount_signup_alt"),  # 覆寫 Allauth 的第三方註冊
    ...
    # 社群媒體功能路由
    path('social/', include('petapp.social_urls')),
